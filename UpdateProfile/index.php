...
<?php
	...
	if(isset($_SESSION['editerror'])){
		...
		$query = "
			SELECT * FROM table_profile WHERE userName='$uname'
		";
	...
	<body>
		<div id='centerArea'>
			...
			<div id='content' style='top:0'>
				...
				<form name="editProfileForm" method="post" action="EditProfileView.php" enctype="multipart/form-data">
					<?php
...
<?php
	...
	if(isset($_SESSION['scriptdriverid'])) unset($_SESSION['scriptdriverid']);
